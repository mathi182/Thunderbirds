...
public class Medical extends Baggage {
    ...
    public Medical(UUID baggageHash, Length linearDimension, Mass weight, Speciality speciality) {
        super(baggageHash, linearDimension, weight, speciality);
    }

    public Medical(Length linearDimension, Mass weight, Speciality speciality) {
